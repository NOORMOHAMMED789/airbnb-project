      ...
      <div className="w-[60%]">
        ...
        <div className="pt-[40px] border-b-[1px] border-[#000-]">
          <div className="flex gap-[16px] pb-[16px]">
            ...
            />
            <div>
              <div className="text-[#000] text-[14px] font-medium">
                Entire home
              </div>
              <div className="text-[#6B7280] text-[14px] font-medium">
                youll have apartment to yourself
              </div>
            </div>
          </div>
          <div className="flex gap-[16px] pb-[16px]">
            ...
            <div>
              ...
              <div className="text-[#6B7280] text-[14px] font-medium">
                This Host commited to Airbnb 5-step enhanced cleaning process.
          ...
          <div className="flex gap-[16px] pb-[16px]">
            ...
            <div>
              ...
              <div className="text-[#6B7280] text-[14px] font-medium">
                Check yourself in with the keyboard
              </div>
            </div>
          </div>
        ...
        <div className="py-[40px] border-b-[1px] border-[#000-]">
          ...
          <div className="border-[#000] border box-border w-fit rounded-[8px] py-[8px] px-[16px] ">
